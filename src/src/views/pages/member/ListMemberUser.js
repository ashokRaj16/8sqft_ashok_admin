...
//   );
  ...
  const loadMemberData = async ( ) => {
    try{
        ...
        const result = await getMemberUser(offset, itemsPerPage, sortConfig.direction, sortConfig.key, searchTerm);
        console.log(result);
            ...
            {currentMembers.map((member, index) => (
              <CTableRow key={index}>
                ...
                <CTableDataCell>
                  ...
                  <CBadge color={getStatusBadge('verified')}>
                    Yes
                  </CBadge> :
                  <CBadge color={getStatusBadge("Inverified")}>
                    No
                </CBadge>
                }</CTableDataCell>
                <CTableDataCell>{member?.created_at}</CTableDataCell>
                {/* <CTableDataCell>
