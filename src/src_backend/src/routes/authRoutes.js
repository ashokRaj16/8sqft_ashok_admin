...
import { sendOtpToMobile, verifyMobileOtp, sendOtpToEmail, verifyEmailOtp, resendOtpToEmail, registerUser, resendOtpToMobile, sendTextMessage} from "../controllers/authController.js";
