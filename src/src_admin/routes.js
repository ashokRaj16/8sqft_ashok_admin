...
const ViewSponsared = React.lazy(() => import('@page/sponsared/ViewSponsaredDetails'))
...
const routes = [
  ...
  { path: '/sponsared/view/:id', name: 'View Sponsared', element: ViewSponsared, allowedRole: ['SUPER ADMIN', 'SUB ADMIN'] },
