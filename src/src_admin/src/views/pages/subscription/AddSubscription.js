...
import { validationSubscriptionSchema } from './validationSubscriptionSchema';
import { createSubscriptionPlan } from '../../../models/subscriptionModel';
import { initialSubscriptionValues } from './data';

const optionCategoryValue =[
    { id: 1, key: "COMMERCIAL", value : "COMMERCIAL" },
    { id: 2, key: "RESIDENTIAL", value : "RESIDENTIAL" },
] 

const optionUserValue =[
    { id: 1, key: "TENANTS", value : "TENANTS" },
    { id: 2, key: "OWNER", value : "OWNER" },
    { id: 3, key: "BUILDER", value : "BUILDER" },
] 

const optionPlanValue =[
                        ...
                        <Form>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    <Field
                                        ...
                                        { optionCategoryValue.length > 0 && optionCategoryValue.map((data) => (
                                            <option key={data.id} value={data?.id}>{ data?.value }</option>
                                        ))}
                                    </Field>
                                    <ErrorMessage name="property_category" component={CFormText} className="text-danger" />
                                    
                                    {/* {errors.property_category && <CFormLabel style={{ color: 'red' }}>{errors.property_category}</CFormLabel>
                                    } */}
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <Field 
                                        ...
                                        id="user_type"  >
                                        <option value={-1}>Select</option>
                                        { optionUserValue.length > 0 && optionUserValue.map((data) => (
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <Field
                                        ...
                                        id="plan_names"  >
                                        <option value={-1}>Select</option>
                                        { optionPlanValue.length > 0 && optionPlanValue.map((data) => (
                                            <option value={data?.key}>{ data?.value }</option>
                                        ))}
                                    </Field>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <CFormInput 
                                        ...
                                        type="text" 
                                        id="duration_days" />
                                        <ErrorMessage name="duration_days" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <CFormInput 
                                        ...
                                        type="text" 
                                        id="leads_counts" />
                                        <ErrorMessage name="leads_counts" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <Field
                                        ...
                                        <option value={-1}>Select</option>
                                        { optionValue.length > 0 && optionValue.map((data) => (
                                            <option value={data?.key}>{ data?.value }</option>
                                        ))}
                                    </Field>
                                    <ErrorMessage name="contact_whatsapp_notification" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    <ErrorMessage name="promotion_on_web" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    <ErrorMessage name="promotion_on_meta" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    >
                                    <ErrorMessage name="paid_promotion_on_sqft" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    <ErrorMessage name="paid_video_promotion" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    <ErrorMessage name="ind_sponsored_ads" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <CFormInput 
                                        ...
                                        onBlur={handleBlur}
                                        id="plan_amount" />
                                        <ErrorMessage name="plan_amount" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    <CFormInput 
                                        ...
                                        <ErrorMessage name="plan_discounted_amount" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
                            ...
                            <CRow className="mb-3">
                                ...
                                <CCol sm={10} md={6} lg={4}>
                                    ...
                                    onBlur={handleBlur}
                                    id="plan_gst_per" />
                                    <ErrorMessage name="plan_gst_per" component={CFormText} className="text-danger" />
                                </CCol>
                            </CRow>
