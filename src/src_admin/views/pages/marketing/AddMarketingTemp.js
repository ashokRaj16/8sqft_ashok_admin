...
import {
  createMarketingWAImageLead,
  createMarketingWAMarathiLead,
  createMarketingWAOwner,
} from '../../../models/marketingModel'
                          ...
                          <CRow className="mb-3">
                            ...
                            <CCol sm={10} md={6} lg={6}>
                              <SearchSelectMaster
                                ...
                                searchTerm={searchTerm}
                                setSearchTerm={setSearchTerm}
                                setSelectedValue={(val) => setFieldValue('property_id', val.id )}
                                options={properties || []}
                              />
                              <ErrorMessage
                                name="property_id"
