...
import ListAdminUser from '@page/admin/ListAdminUser'
import AddAdminUser from '@page/admin/addAdminUser'
import EditAdminUser from '@page/admin/EditAdminUser'
import AddMemberUser from '@page/member/AddMemberUser'
import EditMemberUser from '@page/member/EditMemberUser'
import ListMemberUser from '@page/member/ListMemberUser'
import AddSubscription from '@page/subscription/AddSubscription'
import Profile from '@page/profile/profile'
import AddBlog from '@page/blog/addBlogs'
import BlogCategory from '@page/blog/blogCategory'
import ListSubscription from '@page/subscription/ListSubscription'
import Page404 from '@page/page404/Page404'
import Page500 from '@page/page500/Page500'
import PageNotAuthorize from '@page/page404/PageNotAuthorize'
...
const routes = [
  { path: '/', exact: true, name: 'Home', allowedRole: ['ADMIN'] },
  { path: '/dashboard', name: 'Dashboard', element: Dashboard, allowedRole: ['ADMIN'] },
