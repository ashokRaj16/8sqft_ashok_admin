...
const optionArray = [1, 200, 300, 500]
...
const ListAdminUser = () => {
  ...
  const [itemsPerPage, setItemsPerPage] = useState(optionArray[0]);
  ...
  console.log(typeof (setItemsPerPage), typeof (itemsPerPage))
  ...
  const loadAdminUser = async (offset = 0, per_page = 20, sortOrder = 'asc', sortColumn = '', searchFilter = '') => {
    try {
      ...
      const result = usersData.slice(0, itemsPerPage);
      console.log(result);
      if (result) {
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <CTable align="middle" className="mb-0 border" hover responsive>
            ...
            <CTableBody>
              ...
              <CTableDataCell>{user.book_price}</CTableDataCell> */}
                  ...
                  <CTableDataCell>{user.imgSrc}</CTableDataCell>
                  <CTableDataCell>
          ...
          <CRow className="mt-3">
            ...
            <DropdownPage id='test'
              className="me-2"
              style={{ color : 'red', textDecoration: 'underline' }}
              optionObject={optionArray}
