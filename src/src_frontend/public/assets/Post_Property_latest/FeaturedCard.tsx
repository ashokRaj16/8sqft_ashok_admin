...
<Card className=" min-w-[348px]  rounded-lg overflow-hidden shadow-lg flex-shrink-0 mb-4  relative bg-white">
  <CardContent className="p-4 ">
    <Image
      ...
      width={150}
      height={50}
      className="w-full lg:w-full h-40 object-cover rounded-md"
    />
    <CardHeader className="sm:space-y-1 text-left p-0">
