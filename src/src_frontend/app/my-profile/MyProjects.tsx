...
const MyProjects: React.FC<BasicProfileProps> = ({ setActiveSection, userType }) => {
    ...
    // console.log("total propertyyyyyyy", totalCounts);
    ...
    const fetchMyProperties = async (pageNumber: number, isInitial = false) => {
        try {
            ...
            // console.log("pagesss", calculatedTotalPages);
    ...
    const filteredProperties = properties.filter((property) => {
        if (selectedFilter === "All") {
            // Show only PROJECT, OpenLand, and PG properties in All
            return (
        ...
        switch (selectedFilter) {
            ...
            case "OpenLand":
                return property.property_type.toLowerCase() === "openland" || property.property_type.toLowerCase() === "pg";
    ...
    const isShowMoreVisible = filteredProperties.length > limit;

    // console.log(totalCounts > limit, "dataaaaaaa")
        ...
        <>
            <>
                ...
                {isMobile ? (
                    ...
                    <div className="p-2">
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-row items-center gap-4 mb-4">
                                ...
                                <h1 className="text-lg text-[#222222] font-medium align-middle mx-auto pb-2">My Projects</h1>
                            </div>
                        ...
                        {filteredProperties.length === 0 ? (
                            <>
                                <p className="text-center text-gray-500">Currently, there is no Projects.</p>
                            </>
                        ) : (
                            <>
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <div className="flex-1 ">
                                                        ...
                                                        {/* <p className="text-[#A4A4A4] text-sm">
                                                           ...
                                                           <p className="font-sm "><span className="text-[#A4A4A4] text-[14px]">Expected Price:</span> {property.rent_amount}</p>
           
                                                           <p className="font-sm TEXT-SM  whitespace-nowrap"><span className="text-[#A4A4A4]" text-sm  >Per Sqft Price:</span>₹{property.per_sqft_amount}</p> */}

                                                        {selectedFilter === "Residentail" && property.property_rent_buy === "RENT" && property.property_type?.toLocaleLowerCase() === "residential" && (
                                                            <>
                                                                <p className="font-sm">
                                                    ...
                                                    <div className="flex flex-row sm:flex-row gap-2 mt-1 h-[38px]">
                                                        <button
                                                            ...
                                                            className={`w-full sm:w-auto p-1 rounded-md border-2 text-center text-[10px] 
                    ...
                    <>
                        <div className="p-4">
                            <h1 className="text-xl font-semibold mb-4 border-b-2 border-black">My Projects</h1>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {filteredProperties.map((property) => Number(property.status) === 1 ? (
                                        ...
                                        >
                                            ...
                                            <div className="relative w-1/2 h-42 min-h-[150px]">
                                                <Image
                                                    src={property.property_img_url || "/placeholder.jpg"}
                                                    alt={property.property_title || "Property Image"}
                                                    layout="fill"
                                            ...
                                            <div className="w-1/2 flex flex-col justify-between">
                                                <div >
                                                    ...
                                                    {/* <p className="font-sm ">
                                                           <span className="text-[#A4A4A4]">Expected Price:</span>{" "}
                                                           {property.rent_amount}
                                                       </p>
           
                                                       <p className="font-sm ">
                                                           <span className="text-[#A4A4A4]">Per Sqft Price: </span>₹{" "}
                                                           {property.per_sqft_amount}
                                                       </p>
           
                                                       <p className="font-sm">
                                                           <span className="text-[#A4A4A4]">Builtup Area:</span>{" "}
                                                ...
                                                <div className="flex flex-row w-full gap-4 mr-4 ">
                                                    <button
                                                        ...
                                                        className={` text-sm px-[6px] rounded-md border-2 
                                                            ${isClicked
                                            ...
                                            <div className="w-1/2 flex flex-col justify-between">
                                                ...
                                                <div className="flex flex-row w-full gap-2 mr-4 ">
                                                    <button
                                                        ...
                                                        className={` text-sm px-[1.8px] rounded-md border-2 
                                                            ${isClicked
                                                                ? "bg-primary text-white border-primary"
                                                                : "text-primary border-primary"
                                                            }`}
                                                    ...
                                                    <ShortlistedUsers isOpenShortlist={isModalOpen} onClose={() => setIsModalOpen(false)} propertyId={selectedPropertyId} />



                                                    <button
                                                        onClick={() => handleOpenModal(property.id)}
                                                        className="text-primary text-sm border-2 border-primary p-[1px] rounded-md "
                                                    >
                                                        Contacted:{property.contactedCount + property.leadCount}
                                                    </button>
