...
import GalleryComponent from "./Gallary";
...
export default function PostPropertyformResidential(): JSX.Element {
  ...
  const Tablinks: TabComponent[] = [
    ...
    { num: "2", title: "Amenities", Component: AmenitiesComponent },
    { num: "3", title: "Gallery & Verification", Component: GalleryComponent },
