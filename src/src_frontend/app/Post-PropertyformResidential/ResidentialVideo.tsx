...
//         const uploadedVideos = response.data[selectedType];
//         const newFiles = uploadedVideos.map((video: any) => ({
//           id: video.id,
//           url: video.videoUrl,
...
//       } else {
//         toast.error(`No video data received for ${selectedType}.`);
//       }
//     },
//     onError: (error: any) => {
...
//     if (!selectedType) {
//       toast.error("Please select a type before uploading a video.");
//       return;
//     }
...
//         const payload: gallaryPostVideos = {
//           property_id: Number(userid), // Replace with the actual property_id
//           video_title: selectedType, // Use selectedType as the title
//           videos: file, // Add the file itself
//         };
...
//           Add videos to get better response
//         </h3>
//         <p className="text-m text-base " style={{ color: "#B6B6B6" }}>
//           Maximum you can upload 5 videos
//         </p>
...
//               <p className="text-sm font-semibold text-gray-800">{file.type}</p>
//               <button
//                 onClick={() => handleRemoveFile(index)}
//                 className="bg-red-500 text-black px-3 py-1 rounded mt-2"
//               >
//                 {file.name}
//                 <FiTrash size={20} />
//               </button>
