...
//       try {
//         const response = await axios.get<BlogResponse>("/api/v1/front/blog", {
//           headers: {
...
//                         className="text-primary border-b-[1px] border-primary cursor-pointer"
//                       >
//                         Read More..
//                       </button>
//                     </div>
...
const Blog = () => {
  ...
  const selectedCatID = searchParams.get("catID"); // Get catID from URL
    ...
    const fetchBlogs = async () => {
      try {
        ...
        if (response.data.status) {
          ...
          // // Filter by selected category and catID
          // if (selectedCategory && selectedCatID) {
          //   filteredBlogs = filteredBlogs.filter(
          //     (blog) => blog.category_title === selectedCategory && blog.cat_id === parseInt(selectedCatID)
          //   );
          // }
