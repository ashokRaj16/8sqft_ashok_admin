        ...
        {properties?.map((property: any) => {
          const features = [
            ...
            },
            {
              ...
              label: property.publish_date
                ? new Date(property.publish_date).toLocaleDateString("en-IN")
                : "Na",
              alt: "Posted On Icon",
              subLabel: "Posted On",
            },
            ...
            >
              <Head>
                <script
                  ...
                  src="https://platform-api.sharethis.com/js/sharethis.js#property=679778caeec4bb0012d85a05&product=inline-share-buttons&source=platform"
                  async
                ></script>
              </Head>
              {/* Heading */}
              <div className=" bg-[#ebebeb] p-3 lg:p-5 lg:flex justify-between">
                <div>
